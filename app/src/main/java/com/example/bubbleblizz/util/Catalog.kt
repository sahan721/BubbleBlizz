...
object Catalog {
    val products = listOf(
        ...
        Product("choco_milk","Chocolate Milk","400 ml",550,4.5,
            "Rich creamy milk blended with cocoa.","img_choco_milk","Dairy Drink"),
        Product("strawberry_milk","Strawberry Milk","400 ml",560,4.4,
            "Sweet strawberry-flavored chilled milk.","img_strawberry_milk","Dairy Drink"),
        Product("banana_milk","Banana Milk","400 ml",540,4.5,
            "Smooth banana flavor in creamy milk.","img_banana_milk","Dairy Drink"),
        Product("vanilla_milkshake","Vanilla Milkshake","500 ml",580,4.6,
            "Classic vanilla shake with rich, thick texture.","img_vanilla_milkshake","Dairy Drink"),
        Product("milo","Milo","500 ml",600,4.7,
            "Chocolate-malt energy drink loved by all.","img_milo","Dairy Drink"),
        Product("coffee_milk","Coffee Milk","400 ml",590,4.5,
            "Mild coffee taste mixed with milk sweetness.","img_coffee_milk","Dairy Drink"),
        Product("oreo_shake","Oreo Milkshake","500 ml",620,4.8,
            "Crunchy Oreos blended into creamy shake.","img_oreo_shake","Dairy Drink"),
        Product("caramel_latte","Caramel Latte","400 ml",650,4.6,
            "Sweet caramel with steamed milk and espresso.","img_caramel_latte","Dairy Drink"),
        Product("matcha_latte","Matcha Latte","400 ml",660,4.7,
            "Creamy blend of matcha and milk.","img_matcha","Dairy Drink"),
        Product("hazelnut_milk","Hazelnut Milk","400 ml",640,4.4,
            "Nutty, slightly sweet and refreshing milk.","img_hazelnut_milk","Dairy Drink"),
